...
Unlike Thomas, the bartender had some reservations at Chez Foie[^safeway], which was why he had-n't tried to explain in detail his conviction for, disarmed as he was, he was disable to tarry long. Chez Foie, despite its immensity, had few ifs-ands-or-buts about tardy patrons. Hurriedly, this humble servant publican[$ a drinkserf, if you will] donned-doffed outergarbs, genuflected [$ genufluct?] towards-away⹀from[$ This merits explanation. The double hyphen ⹀ is used for several purposes throughout history, but in this text (and certain other genius texts) it is used to indicate a hyphenated phrase located within another hyphenated phrase. The more-closely⹀bound phrase receives the double hyphen. This prevents ambiguity. The double hyphen is sometimes approximated with an equals sign (=) instead of an actual double hyphen character (⹀). This system can be extended arbitrarily, but because there is no triple hyphen in unicode you're quickly going to have to approximate that ≡ or ⹀̅, and then at some point you might as well just start writing, eg, -⁴. But, anyway... ~M] the bar-patrons & dartboards and maître d'arts[$ maitre d'eez nuts], and left-arrived.
...
[^reservations]: hence the multiple reservations
